...
exports.BenefitAssignmentModel = void 0;
const database_1 = __importDefault(require("../config/database"));
class BenefitAssignmentModel {
    static async create(data) {
        const result = await database_1.default.query(`INSERT INTO benefit_assignments (
    ...
    static async findById(id) {
        const result = await database_1.default.query('SELECT * FROM benefit_assignments WHERE id = $1', [id]);
    ...
    static async update(id, data) {
        ...
        paramCount++;
        values.push(id);
        const result = await database_1.default.query(`UPDATE benefit_assignments SET ${fields.join(', ')} WHERE id = $${paramCount} RETURNING *`, values);
        if (result.rows.length === 0)
            return null;
        return this.mapRowToAssignment(result.rows[0]);
    }
...
exports.BenefitAssignmentModel = BenefitAssignmentModel;
//# sourceMappingURL=BenefitAssignment.js.map